...
class EzDetectLoss(nn.Module):
    ...
    def forward(self, confOut, bboxOut, target):
        ...
        print(bboxMasks.shape)

        print('target', bboxTarget.shape)
        print('outdata', bboxOut.data.shape)
        print('out:', bboxOut.shape)
        print('mask:>>>>>>>>>>>>>>', bboxMasks)
        print('out:???????????????', bboxOut)
        print('xxx'*100)
        print(bboxOut.data[bboxMasks])
        ...
        print('*'*100)
        print(bboxSamples)
        print(bboxTarget.shape)
        print('*'*100)
        print(bboxSamples.shape)
